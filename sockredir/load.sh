...
clang -O2 -target bpf -I/usr/include/linux/ -I/usr/src/linux-headers-$(uname -r)/include/ -c bpf_sockops_v4.c -o bpf_sockops_v4.o
...
clang -O2 -Wall -target bpf -I/usr/include/linux/ -I/usr/src/linux-headers-$(uname -r)/include/ -c bpf_tcpip_bypass.c -o bpf_tcpip_bypass.o
